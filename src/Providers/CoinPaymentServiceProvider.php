...
namespace Harrison\CoinPayment\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Database\Eloquent\Factory;
use Harrison\CoinPayment\Classes\CoinPaymentClass;

use Harrison\CoinPayment\Console\chekcingTransactionCommand;
use Harrison\CoinPayment\Console\EnabledIPNCommand;
